...
CREATE TABLE MEMBER (
    ...
    MARKET_NY CHAR(1) DEFAULT 'N' NOT NULL CONSTRAINT MARKET_NY_CK CHECK(MARKET_NY IN('Y','N')) -- 마케팅 정보공유 동의 여부
);
...
CREATE TABLE UPLOAD(
    ...
    UPL_MENU NUMBER NOT NULL CHECK(UPL_STT IN(1,2,3,4)), -- 대회1/챌린지2/프로필3/배경이미지4
    UPL_NO NUMBER NULL,
    ORIGIN_NAME VARCHAR2(60) NOT NULL,
    CHANGE_NAME VARCHAR2(60) NOT NULL,
    VER_STATUS CHAR(1) DEFAULT 'N' CHECK(UPL_VER IN('Y','N')),
...
INSERT INTO CONTEST_CHALLENGE VALUES(SEQ_CHLG_NO.NEXTVAL,'고깃덩이하늘날다',TO_DATE('20221231110303','YYYYMMDDHH24MISS'),TO_DATE('20221231140000','YYYYMMDDHH24MISS'),8,'N',NULL,'N',NULL,'Qdfca12',1);
INSERT INTO CONTEST_CHALLENGE VALUES(SEQ_CHLG_NO.NEXTVAL,'Road To Run',TO_DATE('20221231100457','YYYYMMDDHH24MISS'),TO_DATE('20221231130000','YYYYMMDDHH24MISS'),10,'N',NULL,'Y',NULL,'wSDF23',1);
INSERT INTO CONTEST_CHALLENGE VALUES(SEQ_CHLG_NO.NEXTVAL,'위드런',SYSDATE,TO_DATE('20230319124000','YYYYMMDDHH24MISS'),4,'N',NULL,'N',NULL,'wSDF23',3);
INSERT INTO CONTEST_CHALLENGE VALUES(SEQ_CHLG_NO.NEXTVAL,'날으는돈까스',SYSDATE,TO_DATE('20231105140000','YYYYMMDDHH24MISS'),5,'Y',TO_DATE('20230224153221','YYYYMMDDHH24MISS'),'N','vdfety1111','cvxzv34',5);
INSERT INTO CONTEST_CHALLENGE VALUES(SEQ_CHLG_NO.NEXTVAL,'LOOLULALLA',SYSDATE,TO_DATE('20231105133000','YYYYMMDDHH24MISS'),4,'N',NULL,'N',NULL,'Qdfca12',5);
...
INSERT INTO NORMAL_CHALLENGE VALUES(SEQ_NCHLG_NO.NEXTVAL,'즐런인서울',TO_DATE('20230121130041','YYYYMMDDHH24MISS'),TO_DATE('20230204183000','YYYYMMDDHH24MISS'),20,DEFAULT,NULL,DEFAULT,NULL,'Qdfca12',01);
INSERT INTO NORMAL_CHALLENGE VALUES(SEQ_NCHLG_NO.NEXTVAL,'광품달(광안리를 품고 달리다)',DEFAULT,TO_DATE('20230301183000','YYYYMMDDHH24MISS'),20,DEFAULT,NULL,DEFAULT,NULL,'wSDF23',04);
INSERT INTO NORMAL_CHALLENGE VALUES(SEQ_NCHLG_NO.NEXTVAL,'wonder like station 동네사람들',TO_DATE('20230122101328','YYYYMMDDHH24MISS'),TO_DATE('20230221123000','YYYYMMDDHH24MISS'),30,DEFAULT,NULL,'Y',NULL,'vdfety1111',17);
INSERT INTO NORMAL_CHALLENGE VALUES(SEQ_NCHLG_NO.NEXTVAL,'프로경기러',SYSDATE,TO_DATE('20230321233000','YYYYMMDDHH24MISS'),2,'Y',TO_DATE('20230206194852','YYYYMMDDHH24MISS'),'N','vdfety1111','cvxzv34',02);
INSERT INTO NORMAL_CHALLENGE VALUES(SEQ_NCHLG_NO.NEXTVAL,'대한런닝맨',SYSDATE,TO_DATE('20230305190000','YYYYMMDDHH24MISS'),30,DEFAULT,NULL,DEFAULT,NULL,'Qdfca12',01);
