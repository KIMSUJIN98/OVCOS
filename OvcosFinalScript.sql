...
COMMENT ON COLUMN FEED.GPX_URL IS 'GPX파일 경로';
...
INSERT INTO FEED VALUES(SEQ_FEED_INDEX.NEXTVAL, SYSDATE, '오늘 뛴 호수공원 코스 추천합니다','뷰도 좋고 사람도 많지 않아서 좋네요',5,'전체','Y','N',null,'/OVCOS/UPLOAD/GPX/DMZ.gpx',12.5,3.123,12.321,'N','Qdfca12');
INSERT INTO FEED VALUES(SEQ_FEED_INDEX.NEXTVAL, SYSDATE, '오늘의 기록','안양천,30분',4,'친구','Y','N',null,'/OVCOS/UPLOAD/GPX/DMZ2.gpx',12.5,3.123,12.321,'N','wSDF23');
INSERT INTO FEED VALUES(SEQ_FEED_INDEX.NEXTVAL, SYSDATE, '2023/02/05 달리기 ','1시간 달렸는데 개빡셌다. 페이스조절해야지 ',3.5 ,'친구','N','N',null,'/OVCOS/UPLOAD/GPX/DMZ3.gpx',12.5,3.123,12.321,'N','cvxzv34');
INSERT INTO FEED VALUES(SEQ_FEED_INDEX.NEXTVAL, DEFAULT, '2021 안양공원 달리기 코스 ','날씨가 춥긴 춥다',3,'비공개','N','N',null,'/OVCOS/UPLOAD/GPX/DMZ3.gpx',12.5,3.123,12.321,'N','vdfety1111');
INSERT INTO FEED VALUES(SEQ_FEED_INDEX.NEXTVAL, SYSDATE, '한강달리기는 옳다','갓생사는기분',5,DEFAULT,'Y','N',null,'/OVCOS/UPLOAD/GPX/DMZ3.gpx',12.5,3.123,12.321,DEFAULT,'wSDF23');
...
INSERT INTO NOTICE VALUES(SEQ_NTC_NO.NEXTVAL,'이벤트 당첨 안내입니다.','이벤트 결과 이*근님(hhg**), 김*진님(ott**) 당첨입니다.',TO_DATE('20230102140015','YYYYMMDDHH24MISS'),DEFAULT);
