...
/**
 * Servlet implementation class ContestChallengeEntryController
 */
@WebServlet("/entryInsert.ch")
public class AjaxContestChallengeEntryInsertController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AjaxContestChallengeEntryInsertController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result = new ChallengeService().insertEntryList(el);
