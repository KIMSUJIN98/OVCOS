<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
  ...
  <body>
	...
	<% if (id != null) { %>
		<span id="yourId">회원님의 아이디는</span><span id="id"><%=id %></span><span id="is"></span></div>
  <button type="submit" class="next_btn" onclick="location.href='<%=contextPath%>/views/loginRegister/login.jsp'">로그인</button>
  <button type="submit" class="next_btn" onclick="location.href='<%=contextPath%>/views/loginRegister/findPwd.jsp'">비밀번호 찾기</button>
	<% } else { %>
	<div>
