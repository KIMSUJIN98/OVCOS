              ...
              <form id="find_id" action="<%=contextPath %>/findId.me" method="post">
                <table>
                  ...
                  <tr>
                    ...
                    <td>
                      <button type="button" id="authBtn" onclick="callServlet()">인증요청</button></td>
                     <td> <input type="hidden" readonly="readonly" name="codeCheck" id="codeCheck" value="<%=getRandom()%>">
                    </td>
                  </tr>
                  <tr>
                            <td></td>
       ...
       <%--  <div class="modal" id="findIdModal">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <br>
              <button type="submit" class="btn btn-outline-dark" id="loginBtn" onclick="location.href='<%=contextPath%>/views/loginRegister/login.jsp'">로그인</button>
              <button type="submit" class="btn btn-outline-dark" id="updatePwdBtn" onclick="location.href='<%=contextPath%>/views/loginRegister/findPwd.jsp'">비밀번호 재설정</button>
              <% } else { %>
                <div>
                  <p>
                ...
                <div>
                  <button type="submit" class="btn btn-outline-dark" id="signinBtn" onclick="location.href='<%=contextPath%>/views/loginRegister/signin_agree.jsp'">회원가입</button>
                  <button type="submit" class="btn btn-outline-dark" id="loginBtn" onclick="location.href='<%=contextPath%>/views/loginRegister/login.jsp'">로그인</button>
                  <% } %>
                </div>
              </div>
