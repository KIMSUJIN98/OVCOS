...
<meta charset="UTF-8">
<link rel="stylesheet"
href="${pageContext.request.contextPath}/resources/css/feedMainStyle.css?문자열">
...
<div id="ct1">
    <div id="record">
        ...
        <div id="recode1">
            <div id="profile">
                <div id="profile_img">
                    <img src="${pageContext.request.contextPath}/resources/image/mypage.png"
                        alt="프로필이미지">
                </div>
                <a href="#" id="username">
                    <h3>
            ...
            <div id="ac_recode">
                <div id="last_ac1">
                    ...
                    <div id="last_info"><a href="#"
                            id="f_title">피드제목&nbsp;<span>2023-02-11</span></a>
                    </div>
                ...
                <div id="last_ac3">
                    ...
                    <div id="km2" class="km"><a href="#">0km</a>
                    </div>
                </div>
            </div>
    ...
    <div id="notice"><a href="<%=contextPath%>/list.no">서버 점검 예정
            2023-03-03</a></div>
</div>
...
<div id="ct2">
    ...
    <div id="content_feed">
        ...
        <div id="feed_search">
            ...
            <div id="search_btn">
                <img src="${pageContext.request.contextPath}/resources/image/search.png"
                    alt="검색">
            </div>
        </div>
                            ...
                            <div class="feed_table">
                                <table border="0px" id="f_table">
                                    <tr id="tr1">
                                        ...
                                        <td id="plus">
                                            <div>
                                                <img src="${pageContext.request.contextPath}/resources/image/more.png"
                                                    alt="더보기 버튼">
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td colspan="3" id="gpx">
                                            <div>
                                                <img src="${pageContext.request.contextPath}/resources/image/gpx_ex.png"
                                                    alt="">
                                            </div>
                                        </td>
                                    </tr>
